  ...
  return (
    <div ref={sectionRef} className="relative w-full h-full bg-gradient-to-br from-slate-950 via-slate-900 to-cyan-950 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-20">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-cyan-200 bg-clip-text text-transparent">
            Let's Connect
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-slate-700/50 shadow-xl hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-300 hover:border-cyan-500/30">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:mihailache100@gmail.com" className="text-slate-200 hover:text-cyan-400 transition-colors">
            ...
            <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-slate-700/50 shadow-xl hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-300 hover:border-cyan-500/30">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="https://linkedin.com/in/mihailache" target="_blank" rel="noopener noreferrer" className="text-slate-200 hover:text-cyan-400 transition-colors">
            ...
            <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-slate-700/50 shadow-xl hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-300 hover:border-cyan-500/30">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-slate-400 font-medium">GitHub</p>
                  <a href="https://github.com/mihailache" target="_blank" rel="noopener noreferrer" className="text-slate-200 hover:text-cyan-400 transition-colors">
